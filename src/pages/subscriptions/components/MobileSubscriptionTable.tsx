                ...
                >
                    ...
                    <div className="p-4">
                        <div className="flex justify-between mt-3">
                                <div>
                                <h6 className="text-black-50 text-3sm">AMOUNT</h6>
                                <p className="text-2md mt-1">
                                                £ {element?.amount}
                                </p>
                                </div>
                                <div>
                                                <h6 className="text-green-100 text-3sm">Download Reciept</h6>
                                </div>
                        </div>
                        <div className="flex justify-between mt-3">
                                <div>
                        ...
                        <div className="flex justify-between mt-3">
                            <div>
                                <h6 className="text-black-50 text-3sm">MONTH PAID</h6>
                                <p className="text-2md mt-1">
                                    {element?.monthPaid}
                                </p>
                            </div>
