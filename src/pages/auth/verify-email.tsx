    ...
    return (
        <div className="bg-black grid grid-cols-2 text-white">
            ...
            <div className="my-8 mr-8 bg-white  pt-[82px] px-16 flex flex-col rounded-lg">
                ...
                <span className="text-base text-blaq w-fit pt-2">
                    Enter the 6-digit OTP we sent to alisoneyo@email.com to
                    proceed with your password reset process.
                </span>
                ...
                <h2 className="text-base text-blaq font-bold pb-4">
                    Enter OTP
                </h2>
                <OtpContainer handleSubmit={handleVerifyEmail} />
                <span className="underline text-center text-base text-light-green pt-8 font-medium cursor-pointer">
                    Not my email
                </span>
            </div>
        </div>
