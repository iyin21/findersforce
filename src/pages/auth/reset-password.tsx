            ...
            <div className="my-8 mr-8 bg-white  pt-[90px] px-16 flex flex-col rounded-lg">
                {!passwordChanged ? (
                    <>
                        ...
                        <h1 className="font-extrabold text-blaq text-4xl pt-4">
                            Reset Password
                        </h1>
                        <span className="text-base pt-2.5 text-blac">
                    ...
                    <>
                        <h1 className="pt-[60px] text-4xl font-extrabold text-blaq">
                            Password changed
                        </h1>
                        <span className="pt-2 text-pas text-base">
