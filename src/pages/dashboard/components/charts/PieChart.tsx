...
const PieChart = ({
    ...
    const taskDistribution: any = dashboardAnalytics?.jobTypeDistribution?.map(
        (item) => {
            const arr = []
    ...
    return (
        <div className="bg-white-100 py-4 border border-black-10 rounded-lg cursor-pointer w-[100%] my-8">
            ...
            <p className="text-sm text-black-50 pb-4 px-8">
                Task type distribution for operatives you have hired
            </p>
            <Chart
                chartType="PieChart"
