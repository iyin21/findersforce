        ...
        <div   className="px-4">
          <div className="bg-yellow-5 rounded-t-lg pt-8 cursor-pointer ">
            <div className="flex justify-between">
              <div className="p-4">
                <p className="font-extrabold text-2xl">{dashboardAnalytics?.shiftsCompleted?.total}</p>
                <p className="text-xs tracking-wider">SHIFTS COMPLETED</p>
              </div>
              <p className="text-xs p-4">This Month <span className="text-green-100 text-base font-extrabold">{dashboardAnalytics?.shiftsCompleted?.thisMonth}</span></p>
            </div>
          ...
          <div className="flex bg-red-10 justify-between rounded-b-lg py-2">
            <div className="flex "> 
              ...
              <p className="text-xs font-medium text-red-100">SHIFTS CANCELED <br />
                <span className="text-xl font-extrabold text-black-100">{dashboardAnalytics?.shiftsCancelled?.thisMonth} </span>
