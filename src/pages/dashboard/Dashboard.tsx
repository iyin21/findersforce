        ...
        <div className="flex flex-row gap-8 justify-between">
          <div className="basis-3/4">
            <section className="bg-dashboard-pattern h-42 bg-cover text-white-100 pl-5 pb-5 rounded-lg">
              ...
              <p className="pt-2 text-white-30"> Manage your hiring in 2 steps </p>
              <span className="text-yellow-100 font-medium pt-2 pb-5">Start posting jobs</span>
          ...
          <div className="basis-1/4">
            ...
            <section>
              <div className="relative my-5 rounded-lg">
                <p className="text-md font-medium  sticky top-0 bg-gray-100 rounded-t-lg py-3 pl-4 "> ACTIVE SHIFTS <span className="text-md font-bold text-green-100 sticky top-0 cursor-pointer ml-12">See All</span></p>
                <ShiftCard
              ...
              <div className="overflow-y-scroll  h-52 relative rounded-t-lg my-5">
                <p className="text-md font-medium sticky z-20 top-0 bg-gray-100 rounded-t-lg py-3 pl-4 "> UPCOMING SHIFTS  <span className="text-md font-bold text-green-100 sticky top-0  cursor-pointer ml-12">See All</span></p>
                  <ShiftCard 
                    profileImage={ProfileImage}
                    profileName={"Shaquan Roberts"}
