...
const Sidebar = () => {
  return (
    <aside className="w-full text-base h-full pt-2 pb-2 bg-primary-1 z-30">
            <img src={FindersForceLogo} alt="" className="p-3 my-5 ml-5"/>
           <section className="flex p-3 rounded-lg ml-1 mb-4 mr-1 bg-primary-10">
                    ...
                    <div className="p-1 text-white-30">
                      ...
                      <p className="text-xs">recruit@leftfieldlabs.com</p>
                    </div>
           </section>
           <p className="text-primary-60 my-2 font-bold text-base px-4 py-2">FINDERS HUB</p>
           <ul className="pb-16">
                { RegionalManagerRoute.map((item, index) => {
                  return (
                          <NavLink 
                            to={item.route} 
                            key={index} 
                            className={({ isActive }) => isActive ? `flex p-4    ${styles.active}` : "flex p-4 text-primary-10"
                          } >
                            <item.icon/>
           ...
           <hr className="bg-primary-10 border-2 w-10/12 m-auto"/>
